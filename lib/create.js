...
module.exports.createProject = async (platform_dir, package_name, project_name, options) => {
/*
...
*/
    ...
    if (fs.existsSync(platform_dir)) {
        throw new Error('Oops, destination already exists! Delete it and try again');
    }

    // Check that requirements are met and proper targets are installed
    if (!check_reqs.run()) {
        throw new Error('Please make sure you meet the software requirements in order to build a cordova electron project');
    }
